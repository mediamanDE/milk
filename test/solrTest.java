...
public class solrTest extends UnitTest {
    ...
    public void TestAddSearchDelete() {
    	...
    	userTemp.set_id(new Random().nextInt());
    	...
    	Group[] arrayGroup = new Group[3];
    	arrayGroup[0] = groupTemp1;
    	arrayGroup[1] = groupTemp2;
    	arrayGroup[2] = groupTemp3;
    	messageTest.setGroups(arrayGroup);
    	
    	// Verbesserung zu Generic
